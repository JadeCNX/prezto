...
if ! zstyle -t ':prezto:module:git:alias' skip; then
  ...
  alias glB='git log --date-order --all --graph --abbrev-commit --branches --pretty=format:"${_git_log_oneline_with_author_format}"'
  alias glb='git log --date-order --graph --abbrev-commit --branches --pretty=format:"${_git_log_oneline_with_author_format}"'
  alias glc='git shortlog --summary --numbered'
  alias gld='git log --date-order --stat --patch --full-diff --pretty=format:"$_git_log_medium_format"'
  alias glD='git log --date-order --stat --patch --word-diff --full-diff --pretty=format:"$_git_log_medium_format"'
  alias glG='git log --date-order --all --graph --pretty=format:"${_git_log_oneline_with_author_format}"'
  alias glg='git log --date-order --graph --pretty=format:"${_git_log_oneline_with_author_format}"'
  alias glM='git log --date-order --all --graph --author=`git config user.name` --pretty=format:"${_git_log_oneline_format}"'
  alias glm='git log --date-order --oneline --author=`git config user.name` --pretty=format:"${_git_log_oneline_format}"'
  alias glms='git log --date-order --oneline --stat --author=`git config user.name` --pretty=format:"${_git_log_oneline_format}"'
  alias glo='git log --date-order --pretty=format:"$_git_log_oneline_with_author_format"'
  alias glp='git log --patch'
  alias glr='git log --date-order --pretty=format:"$_git_log_brief_format"'
