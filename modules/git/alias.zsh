...
if ! zstyle -t ':prezto:module:git:alias' skip; then
  ...
  alias gcma='git commit --message --gpg-sign'
  alias gcmc='git-gen-commit'
  alias gcmC='git-gen-recommit'
  alias gcmd='git-gen-commit --done'
  alias gcmD='git-gen-recommit --done'
  alias gcmg='git-gen-commit --github'
  alias gcmG='git-gen-recommit --github'
  alias gcms='git-gen-commit --setlink'
  alias gcmS='git-gen-recommit --setlink'
